...
namespace System
{
	class Template
	{
		...
		private static $bool_attrs = array('required', 'selected', 'checked');
		...
		{
			Output::content_for("head", '<script type="text/javascript" src="/share/scripts/global.js.php?modules='.implode(';', Output::get_content_from("scripts")).'"></script>');
		}


		public static function styles_out()
		{
			Output::content_for("head", '<link type="text/css" rel="stylesheet" href="/share/styles/global.css.php?modules='.implode(';', Output::get_content_from("styles")).'" />');
		}
