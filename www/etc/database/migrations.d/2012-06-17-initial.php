...
$this->sql("
	CREATE TABLE IF NOT EXISTS `attr` (
		...
		`id_attr_set` int(11) unsigned NOT NULL,
		`id_attr_group` int(11) unsigned NOT NULL,
		...
		`id_tag_root` int(11) unsigned NOT NULL,
...
$this->sql("
	CREATE TABLE IF NOT EXISTS `attr_group` (
		`id_attr_group` int(11) unsigned NOT NULL AUTO_INCREMENT,
		`id_attr_set` int(11) unsigned NOT NULL,
...
$this->sql("
	CREATE TABLE IF NOT EXISTS `attr_set` (
		`id_attr_set` int(11) unsigned NOT NULL AUTO_INCREMENT,
		`name` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
...
$this->sql("
	CREATE TABLE IF NOT EXISTS `attr_value` (
		`id_attr_value` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
$this->sql("
	CREATE TABLE IF NOT EXISTS `database_migration` (
		`id_database_migration` int(11) unsigned NOT NULL AUTO_INCREMENT,
		`seoname` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
		`name` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
...
$this->sql("
	CREATE TABLE IF NOT EXISTS `mailer_body` (
		`id_mailer_body` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
$this->sql("
	CREATE TABLE IF NOT EXISTS `mailer_queue` (
		`id_mailer_queue_item` int(11) unsigned NOT NULL AUTO_INCREMENT,
		`id_mailer` int(11) unsigned NOT NULL,
		`id_mailer_body` int(11) unsigned NOT NULL,
		`id_user_invoker` int(11) unsigned NOT NULL,
...
$this->sql("
	CREATE TABLE `user_contact` (
		`id_user_contact` int(11) unsigned NOT NULL AUTO_INCREMENT,
		`id_user_contact_type` int(11) unsigned NOT NULL,
...
$this->sql("
	CREATE TABLE `user_info` (
		`id_user_info` int(11) unsigned NOT NULL AUTO_INCREMENT,
		`id_user_info_type` int(11) unsigned NOT NULL,
		`id_user` int(11) unsigned NOT NULL,
...
$this->sql("
	CREATE TABLE IF NOT EXISTS `user_perm` (
		`id_user_perm` int(11) unsigned NOT NULL AUTO_INCREMENT,
		...
		`id_user_group` int(11) unsigned NOT NULL DEFAULT '0',
...
$this->sql("
	ALTER TABLE `user_contact`
		ADD FOREIGN KEY (`id_user`) REFERENCES `user` (`id_user`) ON DELETE CASCADE ON UPDATE NO ACTION;
");
